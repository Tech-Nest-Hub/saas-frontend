    ...
    <nav className="flex justify-between items-center w-full mb-7">
      ...
      <div className="flex justify-between items-center gap-5">
        <button className="px-3 py-3 bg-gray-100 rounded-full hover:bg-blue-100"
          ...
          <Menu className="w-4 h-4" size={20} />
        </button>
      ...
      <div className="flex justify-between items-center gap-5">
        <div className="hidden md:flex justify-between items-center gap-5">
          ...
          <div className="relative">
            ...
            <span className="absolute -top-2 -right-2 inline-flex items-center justify-center px-[0.4rem] py-1 text-xs font-semibold 
          ...
          <div className="flex items-center gap-3 cursor-pointer">
            ...
            <span className="font-semibold">Aakash Subedi</span>
          </div>
        </div>
        <Link href="/settings">
